...
--
-- IMPORTANT: This creates a FRESH database schema with sample data.
-- No data migration is needed - we're starting fresh in Supabase.
-- Your local PostgreSQL data was just for testing and won't be migrated.
--
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_button_clicks_button_name ON button_clicks(button_name);
...
DROP TRIGGER IF EXISTS update_button_clicks_updated_at ON button_clicks;
